...
export type Event = Event_System | Event_Balances | Event_Treasury | Event_Utility | Event_Scheduler | Event_Democracy | Event_Elections | Event_Council | Event_TechnicalCommittee | Event_Vesting | Event_Proxy | Event_Tips | Event_CollatorSelection | Event_Session | Event_Preimage | Event_Uniques | Event_Identity | Event_Multisig | Event_ParachainSystem | Event_PolkadotXcm | Event_CumulusXcm | Event_XcmpQueue | Event_DmpQueue | Event_AssetRegistry | Event_XYK | Event_Duster | Event_Exchange | Event_LBP | Event_NFT | Event_MultiTransactionPayment | Event_PriceOracle | Event_RelayChainInfo | Event_Marketplace | Event_TransactionPause | Event_Currencies | Event_Tokens | Event_OrmlXcm | Event_XTokens | Event_UnknownTokens | Event_Sudo
...
export type Type_280 = Type_280_V0 | Type_280_V1 | Type_280_V2

export interface Type_280_V0 {
  __kind: 'V0'
  value: Type_281
}

export interface Type_280_V1 {
  __kind: 'V1'
  value: Type_286
}

export interface Type_280_V2 {
  __kind: 'V2'
  value: Type_292[]
}
...
export type Type_281 = Type_281_WithdrawAsset | Type_281_ReserveAssetDeposit | Type_281_TeleportAsset | Type_281_QueryResponse | Type_281_TransferAsset | Type_281_TransferReserveAsset | Type_281_Transact | Type_281_HrmpNewChannelOpenRequest | Type_281_HrmpChannelAccepted | Type_281_HrmpChannelClosing | Type_281_RelayedFrom

export interface Type_281_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V0MultiAsset[]
  effects: Type_283[]
}

export interface Type_281_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: V0MultiAsset[]
  effects: Type_283[]
}

export interface Type_281_TeleportAsset {
  __kind: 'TeleportAsset'
  assets: V0MultiAsset[]
  effects: Type_283[]
}

export interface Type_281_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V0Response
}

export interface Type_281_TransferAsset {
  __kind: 'TransferAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface Type_281_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order[]
...
export interface Type_281_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface Type_281_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface Type_281_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface Type_281_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface Type_281_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V0MultiLocation
  message: Type_281
}

export type Type_286 = Type_286_WithdrawAsset | Type_286_ReserveAssetDeposited | Type_286_ReceiveTeleportedAsset | Type_286_QueryResponse | Type_286_TransferAsset | Type_286_TransferReserveAsset | Type_286_Transact | Type_286_HrmpNewChannelOpenRequest | Type_286_HrmpChannelAccepted | Type_286_HrmpChannelClosing | Type_286_RelayedFrom | Type_286_SubscribeVersion | Type_286_UnsubscribeVersion
...
export type Type_283 = Type_283_Null | Type_283_DepositAsset | Type_283_DepositReserveAsset | Type_283_ExchangeAsset | Type_283_InitiateReserveWithdraw | Type_283_InitiateTeleport | Type_283_QueryHolding | Type_283_BuyExecution

export interface Type_283_Null {
  __kind: 'Null'
}
...
export type Type_288 = Type_288_Noop | Type_288_DepositAsset | Type_288_DepositReserveAsset | Type_288_ExchangeAsset | Type_288_InitiateReserveWithdraw | Type_288_InitiateTeleport | Type_288_QueryHolding | Type_288_BuyExecution
