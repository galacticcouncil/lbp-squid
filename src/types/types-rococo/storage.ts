...
export class AssetRegistryAssetLocationsStorage {
   ...
   *  Native location of an asset.
   */
  async getAsV42(key: number): Promise<v42.AssetLocation | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'AssetRegistry', 'AssetLocations', key)
  }

  async getManyAsV42(keys: number[]): Promise<(v42.AssetLocation | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'AssetRegistry', 'AssetLocations', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.AssetLocation)[]> {
    assert(this.isV42)
...
export class AssetRegistryAssetMetadataMapStorage {
   ...
   *  Metadata of an asset.
   */
  async getAsV42(key: number): Promise<v42.AssetMetadata | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'AssetRegistry', 'AssetMetadataMap', key)
  }

  async getManyAsV42(keys: number[]): Promise<(v42.AssetMetadata | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'AssetRegistry', 'AssetMetadataMap', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.AssetMetadata)[]> {
    assert(this.isV42)
...
export class AssetRegistryAssetsStorage {
   ...
   *  Details of an asset.
   */
  async getAsV42(key: number): Promise<v42.AssetDetails | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'AssetRegistry', 'Assets', key)
  }

  async getManyAsV42(keys: number[]): Promise<(v42.AssetDetails | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'AssetRegistry', 'Assets', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.AssetDetails)[]> {
    assert(this.isV42)
...
export class AssetRegistryLocationAssetsStorage {
   ...
   *  Local asset for native location.
   */
  async getAsV42(key: v42.AssetLocation): Promise<number | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'AssetRegistry', 'LocationAssets', key)
  }

  async getManyAsV42(keys: v42.AssetLocation[]): Promise<(number | undefined)[]> {
    assert(this.isV42)
...
export class AuthorshipAuthorStorage {
   ...
   *  Author of current block.
   */
  async getAsV42(): Promise<Uint8Array | undefined> {
    assert(this.isV42)
...
export class AuthorshipDidSetUnclesStorage {
   ...
   *  Whether uncles were already set in this block.
   */
  async getAsV42(): Promise<boolean> {
    assert(this.isV42)
...
export class AuthorshipUnclesStorage {
   ...
   *  Uncles
   */
  async getAsV42(): Promise<v42.UncleEntryItem[]> {
    assert(this.isV42)
...
export class BalancesAccountStorage {
   ...
   *  NOTE: This is only used in the case that this pallet is used to store balances.
   */
  async getAsV42(key: Uint8Array): Promise<v42.AccountData> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Balances', 'Account', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.AccountData)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Balances', 'Account', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.AccountData)[]> {
    assert(this.isV42)
...
export class BalancesLocksStorage {
   ...
   *  NOTE: Should only be accessed when setting, changing and freeing a lock.
   */
  async getAsV42(key: Uint8Array): Promise<v42.BalanceLock[]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Balances', 'Locks', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.BalanceLock[])[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Balances', 'Locks', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.BalanceLock[])[]> {
    assert(this.isV42)
...
export class BalancesReservesStorage {
   ...
   *  Named reserves on some account balances.
   */
  async getAsV42(key: Uint8Array): Promise<v42.ReserveData[]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Balances', 'Reserves', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.ReserveData[])[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Balances', 'Reserves', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.ReserveData[])[]> {
    assert(this.isV42)
...
export class BalancesStorageVersionStorage {
   ...
   *  This is set to v2.0.0 for new networks.
   */
  async getAsV42(): Promise<v42.Releases> {
    assert(this.isV42)
...
export class CollatorSelectionCandidatesStorage {
   ...
   *  The (community, limited) collation candidates.
   */
  async getAsV42(): Promise<v42.CandidateInfo[]> {
    assert(this.isV42)
...
export class CollatorSelectionInvulnerablesStorage {
   ...
   *  The invulnerable, fixed collators.
   */
  async getAsV42(): Promise<Uint8Array[]> {
    assert(this.isV42)
...
export class CollatorSelectionLastAuthoredBlockStorage {
   ...
   *  Last block authored by collator.
   */
  async getAsV42(key: Uint8Array): Promise<number> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'CollatorSelection', 'LastAuthoredBlock', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(number)[]> {
    assert(this.isV42)
...
export class CouncilProposalOfStorage {
   ...
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV42(key: Uint8Array): Promise<v42.Call | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Council', 'ProposalOf', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.Call | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.Call)[]> {
    assert(this.isV42)
   ...
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV62(key: Uint8Array): Promise<v62.Call | undefined> {
    assert(this.isV62)
    return this._chain.getStorage(this.blockHash, 'Council', 'ProposalOf', key)
  }

  async getManyAsV62(keys: Uint8Array[]): Promise<(v62.Call | undefined)[]> {
    assert(this.isV62)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf', keys.map(k => [k]))
  }

  async getAllAsV62(): Promise<(v62.Call)[]> {
    assert(this.isV62)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf')
  }
   ...
   */
  get isV67() {
    return this._chain.getStorageItemTypeHash('Council', 'ProposalOf') === 'd2fae7f5686547803664d6cd2bcaefd969ca5b3b2ecfc86b2db86610adb3b67b'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV67(key: Uint8Array): Promise<v67.Call | undefined> {
    assert(this.isV67)
    return this._chain.getStorage(this.blockHash, 'Council', 'ProposalOf', key)
  }

  async getManyAsV67(keys: Uint8Array[]): Promise<(v67.Call | undefined)[]> {
    assert(this.isV67)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf', keys.map(k => [k]))
  }

  async getAllAsV67(): Promise<(v67.Call)[]> {
    assert(this.isV67)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf')
  }
   ...
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV68(key: Uint8Array): Promise<v68.Call | undefined> {
    assert(this.isV68)
    return this._chain.getStorage(this.blockHash, 'Council', 'ProposalOf', key)
  }

  async getManyAsV68(keys: Uint8Array[]): Promise<(v68.Call | undefined)[]> {
    assert(this.isV68)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf', keys.map(k => [k]))
  }

  async getAllAsV68(): Promise<(v68.Call)[]> {
    assert(this.isV68)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf')
  }
   ...
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV75(key: Uint8Array): Promise<v75.Call | undefined> {
    assert(this.isV75)
    return this._chain.getStorage(this.blockHash, 'Council', 'ProposalOf', key)
  }

  async getManyAsV75(keys: Uint8Array[]): Promise<(v75.Call | undefined)[]> {
    assert(this.isV75)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf', keys.map(k => [k]))
  }

  async getAllAsV75(): Promise<(v75.Call)[]> {
    assert(this.isV75)
    return this._chain.queryStorage(this.blockHash, 'Council', 'ProposalOf')
  }
...
export class CouncilVotingStorage {
   ...
   *  Votes on a given proposal, if it is ongoing.
   */
  async getAsV42(key: Uint8Array): Promise<v42.Votes | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Council', 'Voting', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.Votes | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Council', 'Voting', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.Votes)[]> {
    assert(this.isV42)
...
export class DemocracyBlacklistStorage {
   ...
   *  (until when it may not be resubmitted) and who vetoed it.
   */
  async getAsV42(key: Uint8Array): Promise<[number, Uint8Array[]] | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Democracy', 'Blacklist', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<([number, Uint8Array[]] | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Democracy', 'Blacklist', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<([number, Uint8Array[]])[]> {
    assert(this.isV42)
...
export class DemocracyDepositOfStorage {
   ...
   *  TWOX-NOTE: Safe, as increasing integer keys are safe.
   */
  async getAsV42(key: number): Promise<[Uint8Array[], bigint] | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Democracy', 'DepositOf', key)
  }

  async getManyAsV42(keys: number[]): Promise<([Uint8Array[], bigint] | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Democracy', 'DepositOf', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<([Uint8Array[], bigint])[]> {
    assert(this.isV42)
...
export class DemocracyNextExternalStorage {
   ...
   *  - `PublicProps` is empty.
   */
  async getAsV42(): Promise<[Uint8Array, v42.VoteThreshold] | undefined> {
    assert(this.isV42)
...
export class DemocracyPreimagesStorage {
   ...
   *  The block number is the block at which it was deposited.
   */
  async getAsV42(key: Uint8Array): Promise<v42.PreimageStatus | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Democracy', 'Preimages', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.PreimageStatus | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Democracy', 'Preimages', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.PreimageStatus)[]> {
    assert(this.isV42)
...
export class DemocracyPublicPropsStorage {
   ...
   *  The public proposals. Unsorted. The second item is the proposal's hash.
   */
  async getAsV42(): Promise<[number, Uint8Array, Uint8Array][]> {
    assert(this.isV42)
...
export class DemocracyReferendumInfoOfStorage {
   ...
   *  TWOX-NOTE: SAFE as indexes are not under an attacker’s control.
   */
  async getAsV42(key: number): Promise<v42.ReferendumInfo | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Democracy', 'ReferendumInfoOf', key)
  }

  async getManyAsV42(keys: number[]): Promise<(v42.ReferendumInfo | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Democracy', 'ReferendumInfoOf', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.ReferendumInfo)[]> {
    assert(this.isV42)
...
export class DemocracyStorageVersionStorage {
   ...
   *  New networks start with last version.
   */
  async getAsV42(): Promise<v42.Type_295 | undefined> {
    assert(this.isV42)
...
export class DmpQueueConfigurationStorage {
   ...
   *  The configuration.
   */
  async getAsV42(): Promise<v42.ConfigData> {
    assert(this.isV42)
...
export class DmpQueueOverweightStorage {
   ...
   *  The overweight messages.
   */
  async getAsV42(key: bigint): Promise<[number, Uint8Array] | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'DmpQueue', 'Overweight', key)
  }

  async getManyAsV42(keys: bigint[]): Promise<([number, Uint8Array] | undefined)[]> {
    assert(this.isV42)
...
export class DmpQueuePageIndexStorage {
   ...
   *  The page index.
   */
  async getAsV42(): Promise<v42.PageIndexData> {
    assert(this.isV42)
...
export class DmpQueuePagesStorage {
   ...
   *  The queue pages.
   */
  async getAsV42(key: number): Promise<[number, Uint8Array][]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'DmpQueue', 'Pages', key)
  }

  async getManyAsV42(keys: number[]): Promise<([number, Uint8Array][])[]> {
    assert(this.isV42)
...
export class ElectionsCandidatesStorage {
   ...
   *  Invariant: Always sorted based on account id.
   */
  async getAsV42(): Promise<[Uint8Array, bigint][]> {
    assert(this.isV42)
...
export class ElectionsMembersStorage {
   ...
   *  Invariant: Always sorted based on account id.
   */
  async getAsV42(): Promise<v42.SeatHolder[]> {
    assert(this.isV42)
...
export class ExchangeExchangeAssetsIntentionCountStorage {
   ...
   *  Intention count for current block
   */
  async getAsV42(key: [number, number]): Promise<number> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Exchange', 'ExchangeAssetsIntentionCount', key)
  }

  async getManyAsV42(keys: [number, number][]): Promise<(number)[]> {
    assert(this.isV42)
...
export class ExchangeExchangeAssetsIntentionsStorage {
   ...
   *  Stored as ( asset_a, asset_b ) combination where asset_a is meant to be exchanged for asset_b ( asset_a < asset_b)
   */
  async getAsV42(key: [number, number]): Promise<v42.ExchangeIntention[]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Exchange', 'ExchangeAssetsIntentions', key)
  }

  async getManyAsV42(keys: [number, number][]): Promise<(v42.ExchangeIntention[])[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Exchange', 'ExchangeAssetsIntentions', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.ExchangeIntention[])[]> {
    assert(this.isV42)
...
export class LBPFeeCollectorWithAssetStorage {
   ...
   *  Not more than one fee collector per asset possible
   */
  async getAsV42(key1: Uint8Array, key2: number): Promise<boolean> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'LBP', 'FeeCollectorWithAsset', key1, key2)
  }

  async getManyAsV42(keys: [Uint8Array, number][]): Promise<(boolean)[]> {
    assert(this.isV42)
...
export class LBPPoolDataStorage {
   ...
   *  Details of a pool.
   */
  async getAsV42(key: Uint8Array): Promise<v42.Pool | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'LBP', 'PoolData', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.Pool | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'LBP', 'PoolData', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.Pool)[]> {
    assert(this.isV42)
...
export class LiquidityMiningLiquidityPoolDataStorage {
   ...
   *  Liquidity pool yield farm details.
   */
  async getAsV42(key1: number, key2: Uint8Array): Promise<v42.LiquidityPoolYieldFarm | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'LiquidityMining', 'LiquidityPoolData', key1, key2)
  }

  async getManyAsV42(keys: [number, Uint8Array][]): Promise<(v42.LiquidityPoolYieldFarm | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'LiquidityMining', 'LiquidityPoolData', keys)
  }

  async getAllAsV42(): Promise<(v42.LiquidityPoolYieldFarm)[]> {
    assert(this.isV42)
...
export class LiquidityMiningLiquidityPoolMetadataStorage {
   ...
   *  `LiquidityPoolYieldFarm` metadata holding: `(asset pair, existing nfts count, global pool id)`
   */
  async getAsV42(key: number): Promise<[v42.AssetPair, bigint, number] | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'LiquidityMining', 'LiquidityPoolMetadata', key)
  }

  async getManyAsV42(keys: number[]): Promise<([v42.AssetPair, bigint, number] | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'LiquidityMining', 'LiquidityPoolMetadata', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<([v42.AssetPair, bigint, number])[]> {
    assert(this.isV42)
...
export class MarketplaceMarketplaceInstancesStorage {
   ...
   *  Stores Marketplace info
   */
  async getAsV42(key1: bigint, key2: bigint): Promise<v42.Royalty | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Marketplace', 'MarketplaceInstances', key1, key2)
  }

  async getManyAsV42(keys: [bigint, bigint][]): Promise<(v42.Royalty | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Marketplace', 'MarketplaceInstances', keys)
  }

  async getAllAsV42(): Promise<(v42.Royalty)[]> {
    assert(this.isV42)
   ...
   *  Stores Marketplace info
   */
  async getAsV75(key1: bigint, key2: bigint): Promise<v75.Royalty | undefined> {
    assert(this.isV75)
    return this._chain.getStorage(this.blockHash, 'Marketplace', 'MarketplaceInstances', key1, key2)
  }

  async getManyAsV75(keys: [bigint, bigint][]): Promise<(v75.Royalty | undefined)[]> {
    assert(this.isV75)
    return this._chain.queryStorage(this.blockHash, 'Marketplace', 'MarketplaceInstances', keys)
  }

  async getAllAsV75(): Promise<(v75.Royalty)[]> {
    assert(this.isV75)
    return this._chain.queryStorage(this.blockHash, 'Marketplace', 'MarketplaceInstances')
  }
...
export class MarketplaceOffersStorage {
   ...
   *  Stores offer info
   */
  async getAsV42(key1: [bigint, bigint], key2: Uint8Array): Promise<v42.Offer | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Marketplace', 'Offers', key1, key2)
  }

  async getManyAsV42(keys: [[bigint, bigint], Uint8Array][]): Promise<(v42.Offer | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Marketplace', 'Offers', keys)
  }

  async getAllAsV42(): Promise<(v42.Offer)[]> {
    assert(this.isV42)
...
export class MarketplacePricesStorage {
   ...
   *  Stores token info
   */
  async getAsV42(key1: bigint, key2: bigint): Promise<bigint | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Marketplace', 'Prices', key1, key2)
  }

  async getManyAsV42(keys: [bigint, bigint][]): Promise<(bigint | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Marketplace', 'Prices', keys)
  }

  async getAllAsV42(): Promise<(bigint)[]> {
    assert(this.isV42)
...
export class MultiTransactionPaymentAcceptedCurrenciesStorage {
   ...
   *  Curated list of currencies which fees can be paid with
   */
  async getAsV42(key: number): Promise<bigint | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'MultiTransactionPayment', 'AcceptedCurrencies', key)
  }

  async getManyAsV42(keys: number[]): Promise<(bigint | undefined)[]> {
    assert(this.isV42)
...
export class NFTClassesStorage {
   ...
   *  Stores class info
   */
  async getAsV42(key: bigint): Promise<v42.ClassInfo | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'NFT', 'Classes', key)
  }

  async getManyAsV42(keys: bigint[]): Promise<(v42.ClassInfo | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'NFT', 'Classes', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.ClassInfo)[]> {
    assert(this.isV42)
...
export class NFTInstancesStorage {
   ...
   *  Stores instance info
   */
  async getAsV42(key1: bigint, key2: bigint): Promise<v42.InstanceInfo | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'NFT', 'Instances', key1, key2)
  }

  async getManyAsV42(keys: [bigint, bigint][]): Promise<(v42.InstanceInfo | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'NFT', 'Instances', keys)
  }

  async getAllAsV42(): Promise<(v42.InstanceInfo)[]> {
    assert(this.isV42)
...
export class ParachainSystemHostConfigurationStorage {
   ...
   *  This data is also absent from the genesis.
   */
  async getAsV42(): Promise<v42.V1AbridgedHostConfiguration | undefined> {
    assert(this.isV42)
...
export class ParachainSystemHrmpOutboundMessagesStorage {
   ...
   *  This will be cleared in `on_initialize` of each new block.
   */
  async getAsV42(): Promise<v42.OutboundHrmpMessage[]> {
    assert(this.isV42)
...
export class ParachainSystemLastHrmpMqcHeadsStorage {
   ...
   *  by the system inherent.
   */
  async getAsV42(): Promise<[number, Uint8Array][]> {
    assert(this.isV42)
...
export class ParachainSystemRelevantMessagingStateStorage {
   ...
   *  This data is also absent from the genesis.
   */
  async getAsV42(): Promise<v42.MessagingStateSnapshot | undefined> {
    assert(this.isV42)
...
export class ParachainSystemReservedDmpWeightOverrideStorage {
   ...
   *  overrides the amount set in the Config trait.
   */
  async getAsV42(): Promise<bigint | undefined> {
    assert(this.isV42)
...
export class ParachainSystemUpgradeRestrictionSignalStorage {
   ...
   *  set after the inherent.
   */
  async getAsV42(): Promise<(v42.V1UpgradeRestriction | undefined)> {
    assert(this.isV42)
...
export class ParachainSystemValidationDataStorage {
   ...
   *  in the trie.
   */
  async getAsV42(): Promise<v42.V1PersistedValidationData | undefined> {
    assert(this.isV42)
...
export class PolkadotXcmCurrentMigrationStorage {
   ...
   *  The current migration's stage, if any.
   */
  async getAsV42(): Promise<v42.VersionMigrationStage | undefined> {
    assert(this.isV42)
...
export class PolkadotXcmQueriesStorage {
   ...
   *  The ongoing queries.
   */
  async getAsV42(key: bigint): Promise<v42.QueryStatus | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'PolkadotXcm', 'Queries', key)
  }

  async getManyAsV42(keys: bigint[]): Promise<(v42.QueryStatus | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'PolkadotXcm', 'Queries', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.QueryStatus)[]> {
    assert(this.isV42)
...
export class PolkadotXcmSafeXcmVersionStorage {
   ...
   *  then the destinations whose XCM version is unknown are considered unreachable.
   */
  async getAsV42(): Promise<number | undefined> {
    assert(this.isV42)
...
export class PolkadotXcmSupportedVersionStorage {
   ...
   *  The Latest versions that we know various locations support.
   */
  async getAsV42(key1: number, key2: v42.VersionedMultiLocation): Promise<number | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'PolkadotXcm', 'SupportedVersion', key1, key2)
  }

  async getManyAsV42(keys: [number, v42.VersionedMultiLocation][]): Promise<(number | undefined)[]> {
    assert(this.isV42)
...
export class PolkadotXcmVersionDiscoveryQueueStorage {
   ...
   *  which is used as a prioritization.
   */
  async getAsV42(): Promise<[v42.VersionedMultiLocation, number][]> {
    assert(this.isV42)
...
export class PolkadotXcmVersionNotifiersStorage {
   ...
   *  All locations that we have requested version notifications from.
   */
  async getAsV42(key1: number, key2: v42.VersionedMultiLocation): Promise<bigint | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'PolkadotXcm', 'VersionNotifiers', key1, key2)
  }

  async getManyAsV42(keys: [number, v42.VersionedMultiLocation][]): Promise<(bigint | undefined)[]> {
    assert(this.isV42)
...
export class PolkadotXcmVersionNotifyTargetsStorage {
   ...
   *  of our versions we informed them of.
   */
  async getAsV42(key1: number, key2: v42.VersionedMultiLocation): Promise<[bigint, bigint, number] | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'PolkadotXcm', 'VersionNotifyTargets', key1, key2)
  }

  async getManyAsV42(keys: [number, v42.VersionedMultiLocation][]): Promise<([bigint, bigint, number] | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'PolkadotXcm', 'VersionNotifyTargets', keys)
  }

  async getAllAsV42(): Promise<([bigint, bigint, number])[]> {
    assert(this.isV42)
...
export class PreimagePreimageForStorage {
   ...
   *  The preimages stored by this pallet.
   */
  async getAsV42(key: Uint8Array): Promise<Uint8Array | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Preimage', 'PreimageFor', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(Uint8Array | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Preimage', 'PreimageFor', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(Uint8Array)[]> {
    assert(this.isV42)
...
export class PreimageStatusForStorage {
   ...
   *  The request status of a given hash.
   */
  async getAsV42(key: Uint8Array): Promise<v42.RequestStatus | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Preimage', 'StatusFor', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.RequestStatus | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Preimage', 'StatusFor', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.RequestStatus)[]> {
    assert(this.isV42)
...
export class PriceOraclePriceDataTenStorage {
   ...
   *  The last ten average values corresponding to the last ten blocks.
   */
  async getAsV42(): Promise<[Uint8Array, v42.BucketQueue][]> {
    assert(this.isV42)
...
export class ProxyAnnouncementsStorage {
   ...
   *  The announcements made by the proxy (key).
   */
  async getAsV42(key: Uint8Array): Promise<[v42.Announcement[], bigint]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Proxy', 'Announcements', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<([v42.Announcement[], bigint])[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Proxy', 'Announcements', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<([v42.Announcement[], bigint])[]> {
    assert(this.isV42)
...
export class ProxyProxiesStorage {
   ...
   *  which are being delegated to, together with the amount held on deposit.
   */
  async getAsV42(key: Uint8Array): Promise<[v42.ProxyDefinition[], bigint]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Proxy', 'Proxies', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<([v42.ProxyDefinition[], bigint])[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Proxy', 'Proxies', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<([v42.ProxyDefinition[], bigint])[]> {
    assert(this.isV42)
...
export class SchedulerAgendaStorage {
   ...
   *  Items to be executed, indexed by the block number that they should be executed on.
   */
  async getAsV42(key: number): Promise<(v42.ScheduledV3 | undefined)[]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Scheduler', 'Agenda', key)
  }

  async getManyAsV42(keys: number[]): Promise<((v42.ScheduledV3 | undefined)[])[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<((v42.ScheduledV3 | undefined)[])[]> {
    assert(this.isV42)
   ...
   *  Items to be executed, indexed by the block number that they should be executed on.
   */
  async getAsV62(key: number): Promise<(v62.ScheduledV3 | undefined)[]> {
    assert(this.isV62)
    return this._chain.getStorage(this.blockHash, 'Scheduler', 'Agenda', key)
  }

  async getManyAsV62(keys: number[]): Promise<((v62.ScheduledV3 | undefined)[])[]> {
    assert(this.isV62)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda', keys.map(k => [k]))
  }

  async getAllAsV62(): Promise<((v62.ScheduledV3 | undefined)[])[]> {
    assert(this.isV62)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda')
  }
   ...
   */
  get isV67() {
    return this._chain.getStorageItemTypeHash('Scheduler', 'Agenda') === 'a9fb8686b2c45018f07d1acfa2b65b42e5155578812ed68edcc85cd8a6f2633d'
  }

  /**
   *  Items to be executed, indexed by the block number that they should be executed on.
   */
  async getAsV67(key: number): Promise<(v67.ScheduledV3 | undefined)[]> {
    assert(this.isV67)
    return this._chain.getStorage(this.blockHash, 'Scheduler', 'Agenda', key)
  }

  async getManyAsV67(keys: number[]): Promise<((v67.ScheduledV3 | undefined)[])[]> {
    assert(this.isV67)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda', keys.map(k => [k]))
  }

  async getAllAsV67(): Promise<((v67.ScheduledV3 | undefined)[])[]> {
    assert(this.isV67)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda')
  }
   ...
   *  Items to be executed, indexed by the block number that they should be executed on.
   */
  async getAsV68(key: number): Promise<(v68.ScheduledV3 | undefined)[]> {
    assert(this.isV68)
    return this._chain.getStorage(this.blockHash, 'Scheduler', 'Agenda', key)
  }

  async getManyAsV68(keys: number[]): Promise<((v68.ScheduledV3 | undefined)[])[]> {
    assert(this.isV68)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda', keys.map(k => [k]))
  }

  async getAllAsV68(): Promise<((v68.ScheduledV3 | undefined)[])[]> {
    assert(this.isV68)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda')
  }
   ...
   *  Items to be executed, indexed by the block number that they should be executed on.
   */
  async getAsV75(key: number): Promise<(v75.ScheduledV3 | undefined)[]> {
    assert(this.isV75)
    return this._chain.getStorage(this.blockHash, 'Scheduler', 'Agenda', key)
  }

  async getManyAsV75(keys: number[]): Promise<((v75.ScheduledV3 | undefined)[])[]> {
    assert(this.isV75)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda', keys.map(k => [k]))
  }

  async getAllAsV75(): Promise<((v75.ScheduledV3 | undefined)[])[]> {
    assert(this.isV75)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Agenda')
  }
...
export class SchedulerLookupStorage {
   ...
   *  Lookup from identity to the block number and index of the task.
   */
  async getAsV42(key: Uint8Array): Promise<[number, number] | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Scheduler', 'Lookup', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<([number, number] | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Scheduler', 'Lookup', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<([number, number])[]> {
    assert(this.isV42)
...
export class SessionKeyOwnerStorage {
   ...
   *  The owner of a key. The key is the `KeyTypeId` + the encoded key.
   */
  async getAsV42(key: [Uint8Array, Uint8Array]): Promise<Uint8Array | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Session', 'KeyOwner', key)
  }

  async getManyAsV42(keys: [Uint8Array, Uint8Array][]): Promise<(Uint8Array | undefined)[]> {
    assert(this.isV42)
...
export class SessionNextKeysStorage {
   ...
   *  The next session keys for a validator.
   */
  async getAsV42(key: Uint8Array): Promise<v42.SessionKeys | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Session', 'NextKeys', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.SessionKeys | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Session', 'NextKeys', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.SessionKeys)[]> {
    assert(this.isV42)
...
export class SessionQueuedKeysStorage {
   ...
   *  will be used to determine the validator's session keys.
   */
  async getAsV42(): Promise<[Uint8Array, v42.SessionKeys][]> {
    assert(this.isV42)
...
export class SystemAccountStorage {
   ...
   *  The full account information for a particular account ID.
   */
  async getAsV42(key: Uint8Array): Promise<v42.AccountInfo> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'System', 'Account', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.AccountInfo)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'System', 'Account', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.AccountInfo)[]> {
    assert(this.isV42)
...
export class SystemBlockHashStorage {
   ...
   *  Map of block numbers to block hashes.
   */
  async getAsV42(key: number): Promise<Uint8Array> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'System', 'BlockHash', key)
  }

  async getManyAsV42(keys: number[]): Promise<(Uint8Array)[]> {
    assert(this.isV42)
...
export class SystemBlockWeightStorage {
   ...
   *  The current weight for the block.
   */
  async getAsV42(): Promise<v42.PerDispatchClass> {
    assert(this.isV42)
...
export class SystemDigestStorage {
   ...
   *  Digest of the current block, also part of the block header.
   */
  async getAsV42(): Promise<v42.Digest> {
    assert(this.isV42)
...
export class SystemEventTopicsStorage {
   ...
   *  no notification will be triggered thus the event might be lost.
   */
  async getAsV42(key: Uint8Array): Promise<[number, number][]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'System', 'EventTopics', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<([number, number][])[]> {
    assert(this.isV42)
...
export class SystemEventsStorage {
   ...
   *  from within the runtime.
   */
  async getAsV42(): Promise<v42.EventRecord[]> {
    assert(this.isV42)
   ...
   *  from within the runtime.
   */
  async getAsV62(): Promise<v62.EventRecord[]> {
    assert(this.isV62)
    return this._chain.getStorage(this.blockHash, 'System', 'Events')
  }
   ...
   */
  get isV67() {
    return this._chain.getStorageItemTypeHash('System', 'Events') === 'eb46c90eaf25b89d2ad650108a271eb9d1475eae42d69f8c19d4ea19562f1ebb'
  }
   ...
   *  from within the runtime.
   */
  async getAsV67(): Promise<v67.EventRecord[]> {
    assert(this.isV67)
    return this._chain.getStorage(this.blockHash, 'System', 'Events')
  }
   ...
   *  from within the runtime.
   */
  async getAsV68(): Promise<v68.EventRecord[]> {
    assert(this.isV68)
    return this._chain.getStorage(this.blockHash, 'System', 'Events')
  }
   ...
   *  from within the runtime.
   */
  async getAsV75(): Promise<v75.EventRecord[]> {
    assert(this.isV75)
    return this._chain.getStorage(this.blockHash, 'System', 'Events')
  }
...
export class SystemExecutionPhaseStorage {
   ...
   *  The execution phase of the block.
   */
  async getAsV42(): Promise<v42.Phase | undefined> {
    assert(this.isV42)
...
export class SystemLastRuntimeUpgradeStorage {
   ...
   *  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
   */
  async getAsV42(): Promise<v42.LastRuntimeUpgradeInfo | undefined> {
    assert(this.isV42)
...
export class TechnicalCommitteeProposalOfStorage {
   ...
   */
  get isV67() {
    return this._chain.getStorageItemTypeHash('TechnicalCommittee', 'ProposalOf') === 'd2fae7f5686547803664d6cd2bcaefd969ca5b3b2ecfc86b2db86610adb3b67b'
  }
...
export class TipsTipsStorage {
   ...
   *  guaranteed to be a secure hash.
   */
  async getAsV42(key: Uint8Array): Promise<v42.OpenTip | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Tips', 'Tips', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.OpenTip | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Tips', 'Tips', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.OpenTip)[]> {
    assert(this.isV42)
...
export class TokensAccountsStorage {
   ...
   *  balances.
   */
  async getAsV42(key1: Uint8Array, key2: number): Promise<v42.Type_426> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Tokens', 'Accounts', key1, key2)
  }

  async getManyAsV42(keys: [Uint8Array, number][]): Promise<(v42.Type_426)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Tokens', 'Accounts', keys)
  }

  async getAllAsV42(): Promise<(v42.Type_426)[]> {
    assert(this.isV42)
...
export class TokensLocksStorage {
   ...
   *  NOTE: Should only be accessed when setting, changing and freeing a lock.
   */
  async getAsV42(key1: Uint8Array, key2: number): Promise<v42.Type_424[]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Tokens', 'Locks', key1, key2)
  }

  async getManyAsV42(keys: [Uint8Array, number][]): Promise<(v42.Type_424[])[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Tokens', 'Locks', keys)
  }

  async getAllAsV42(): Promise<(v42.Type_424[])[]> {
    assert(this.isV42)
...
export class TokensTotalIssuanceStorage {
   ...
   *  The total issuance of a token type.
   */
  async getAsV42(key: number): Promise<bigint> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Tokens', 'TotalIssuance', key)
  }

  async getManyAsV42(keys: number[]): Promise<(bigint)[]> {
    assert(this.isV42)
...
export class TransactionPaymentStorageVersionStorage {
  ...
  async getAsV42(): Promise<v42.Type_174> {
    assert(this.isV42)
...
export class TreasuryProposalsStorage {
   ...
   *  Proposals that have been made.
   */
  async getAsV42(key: number): Promise<v42.Proposal | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Treasury', 'Proposals', key)
  }

  async getManyAsV42(keys: number[]): Promise<(v42.Proposal | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Treasury', 'Proposals', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.Proposal)[]> {
    assert(this.isV42)
...
export class UniquesAccountStorage {
   ...
   *  account can be enumerated.
   */
  async getAsV42(key1: Uint8Array, key2: bigint, key3: bigint): Promise<null | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Uniques', 'Account', key1, key2, key3)
  }

  async getManyAsV42(keys: [Uint8Array, bigint, bigint][]): Promise<(null | undefined)[]> {
    assert(this.isV42)
...
export class UniquesAssetStorage {
   ...
   *  The assets in existence and their ownership details.
   */
  async getAsV42(key1: bigint, key2: bigint): Promise<v42.InstanceDetails | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Uniques', 'Asset', key1, key2)
  }

  async getManyAsV42(keys: [bigint, bigint][]): Promise<(v42.InstanceDetails | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Uniques', 'Asset', keys)
  }

  async getAllAsV42(): Promise<(v42.InstanceDetails)[]> {
    assert(this.isV42)
...
export class UniquesAttributeStorage {
   ...
   *  Metadata of an asset class.
   */
  async getAsV42(key1: bigint, key2: (bigint | undefined), key3: Uint8Array): Promise<[Uint8Array, bigint] | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Uniques', 'Attribute', key1, key2, key3)
  }

  async getManyAsV42(keys: [bigint, (bigint | undefined), Uint8Array][]): Promise<([Uint8Array, bigint] | undefined)[]> {
    assert(this.isV42)
...
export class UniquesClassStorage {
   ...
   *  Details of an asset class.
   */
  async getAsV42(key: bigint): Promise<v42.ClassDetails | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Uniques', 'Class', key)
  }

  async getManyAsV42(keys: bigint[]): Promise<(v42.ClassDetails | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Uniques', 'Class', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.ClassDetails)[]> {
    assert(this.isV42)
...
export class UniquesClassAccountStorage {
   ...
   *  account can be enumerated.
   */
  async getAsV42(key1: Uint8Array, key2: bigint): Promise<null | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Uniques', 'ClassAccount', key1, key2)
  }

  async getManyAsV42(keys: [Uint8Array, bigint][]): Promise<(null | undefined)[]> {
    assert(this.isV42)
...
export class UniquesClassMetadataOfStorage {
   ...
   *  Metadata of an asset class.
   */
  async getAsV42(key: bigint): Promise<v42.ClassMetadata | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Uniques', 'ClassMetadataOf', key)
  }

  async getManyAsV42(keys: bigint[]): Promise<(v42.ClassMetadata | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Uniques', 'ClassMetadataOf', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.ClassMetadata)[]> {
    assert(this.isV42)
...
export class UniquesInstanceMetadataOfStorage {
   ...
   *  Metadata of an asset instance.
   */
  async getAsV42(key1: bigint, key2: bigint): Promise<v42.InstanceMetadata | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Uniques', 'InstanceMetadataOf', key1, key2)
  }

  async getManyAsV42(keys: [bigint, bigint][]): Promise<(v42.InstanceMetadata | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Uniques', 'InstanceMetadataOf', keys)
  }

  async getAllAsV42(): Promise<(v42.InstanceMetadata)[]> {
    assert(this.isV42)
...
export class UnknownTokensAbstractFungibleBalancesStorage {
   ...
   *  double_map: who, asset_id => u128
   */
  async getAsV42(key1: v42.V1MultiLocation, key2: Uint8Array): Promise<bigint> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'UnknownTokens', 'AbstractFungibleBalances', key1, key2)
  }

  async getManyAsV42(keys: [v42.V1MultiLocation, Uint8Array][]): Promise<(bigint)[]> {
    assert(this.isV42)
...
export class UnknownTokensConcreteFungibleBalancesStorage {
   ...
   *  double_map: who, asset_id => u128
   */
  async getAsV42(key1: v42.V1MultiLocation, key2: v42.V1MultiLocation): Promise<bigint> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'UnknownTokens', 'ConcreteFungibleBalances', key1, key2)
  }

  async getManyAsV42(keys: [v42.V1MultiLocation, v42.V1MultiLocation][]): Promise<(bigint)[]> {
    assert(this.isV42)
...
export class VestingVestingSchedulesStorage {
   ...
   *  VestingSchedules: map AccountId => Vec<VestingSchedule>
   */
  async getAsV42(key: Uint8Array): Promise<v42.VestingSchedule[]> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'Vesting', 'VestingSchedules', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(v42.VestingSchedule[])[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'Vesting', 'VestingSchedules', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<(v42.VestingSchedule[])[]> {
    assert(this.isV42)
...
export class XYKTotalLiquidityStorage {
   ...
   *  Total liquidity in a pool.
   */
  async getAsV42(key: Uint8Array): Promise<bigint> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'XYK', 'TotalLiquidity', key)
  }

  async getManyAsV42(keys: Uint8Array[]): Promise<(bigint)[]> {
    assert(this.isV42)
...
export class XcmpQueueInboundXcmpMessagesStorage {
   ...
   *  Inbound aggregate XCMP messages. It can only be one per ParaId/block.
   */
  async getAsV42(key1: number, key2: number): Promise<Uint8Array> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'XcmpQueue', 'InboundXcmpMessages', key1, key2)
  }

  async getManyAsV42(keys: [number, number][]): Promise<(Uint8Array)[]> {
    assert(this.isV42)
...
export class XcmpQueueInboundXcmpStatusStorage {
   ...
   *  Status of the inbound XCMP channels.
   */
  async getAsV42(): Promise<v42.InboundChannelDetails[]> {
    assert(this.isV42)
...
export class XcmpQueueOutboundXcmpStatusStorage {
   ...
   *  The bool is true if there is a signal message waiting to be sent.
   */
  async getAsV42(): Promise<v42.OutboundChannelDetails[]> {
    assert(this.isV42)
...
export class XcmpQueueOverweightStorage {
   ...
   *  `service_overweight`.
   */
  async getAsV42(key: bigint): Promise<[number, number, Uint8Array] | undefined> {
    assert(this.isV42)
    return this._chain.getStorage(this.blockHash, 'XcmpQueue', 'Overweight', key)
  }

  async getManyAsV42(keys: bigint[]): Promise<([number, number, Uint8Array] | undefined)[]> {
    assert(this.isV42)
    return this._chain.queryStorage(this.blockHash, 'XcmpQueue', 'Overweight', keys.map(k => [k]))
  }

  async getAllAsV42(): Promise<([number, number, Uint8Array])[]> {
    assert(this.isV42)
...
export class XcmpQueueQueueConfigStorage {
   ...
   *  The configuration which controls the dynamics of the outbound queue.
   */
  async getAsV42(): Promise<v42.QueueConfigData> {
    assert(this.isV42)
