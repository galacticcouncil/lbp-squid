...
export class AssetRegistryRegisterCall {
     ...
     * Emits 'Registered` event when successful.
     */
    get asV42(): {name: Uint8Array, assetType: v42.AssetType, existentialDeposit: bigint} {
        assert(this.isV42)
...
export class AssetRegistrySetLocationCall {
     ...
     * Emits `LocationSet` event when successful.
     */
    get asV42(): {assetId: number, location: v42.AssetLocation} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class AssetRegistrySetMetadataCall {
     ...
     * Emits `MetadataSet` event when successful.
     */
    get asV42(): {assetId: number, symbol: Uint8Array, decimals: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class AssetRegistryUpdateCall {
     ...
     * Emits `Updated` event when successful.
     */
    get asV42(): {assetId: number, name: Uint8Array, assetType: v42.AssetType, existentialDeposit: (bigint | undefined)} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV42(): {source: Uint8Array, dest: Uint8Array, value: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesSetBalanceCall {
     ...
     * The dispatch origin for this call is `root`.
     */
    get asV42(): {who: Uint8Array, newFree: bigint, newReserved: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV42(): {dest: Uint8Array, value: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CouncilCloseCall {
     ...
     * # </weight>
     */
    get asV81(): {proposalHash: Uint8Array, index: number, proposalWeightBound: bigint, lengthBound: number} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CouncilExecuteCall {
     ...
     * # </weight>
     */
    get asV62(): {proposal: v62.Call, lengthBound: number} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Council.execute') === 'f756b392f95bfba3c3f5b5f0652c2b8406be94906e250d6cb553f747ad24cf8f'
    }
     ...
     * # </weight>
     */
    get asV67(): {proposal: v67.Call, lengthBound: number} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV68(): {proposal: v68.Call, lengthBound: number} {
        assert(this.isV68)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV75(): {proposal: v75.Call, lengthBound: number} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Council.execute') === 'daaddcbca6e5e200c607d9589180f49d3d31e97ab2de63fd36c1ffd97d46dd10'
    }
     ...
     * # </weight>
     */
    get asV81(): {proposal: v81.Call, lengthBound: number} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Council.execute') === 'b2b1c0e7f4511d93a6a32b97710c181e354b364fa4ebc6ca92f4dfbb24b71857'
    }
     ...
     * # </weight>
     */
    get asV87(): {proposal: v87.Call, lengthBound: number} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CouncilProposeCall {
     ...
     * # </weight>
     */
    get asV62(): {threshold: number, proposal: v62.Call, lengthBound: number} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Council.propose') === 'dabafe4da08f584ad7756291939b11a8311a6dc59d804a2c765fca7d48f6e795'
    }
     ...
     * # </weight>
     */
    get asV67(): {threshold: number, proposal: v67.Call, lengthBound: number} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV68(): {threshold: number, proposal: v68.Call, lengthBound: number} {
        assert(this.isV68)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV75(): {threshold: number, proposal: v75.Call, lengthBound: number} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Council.propose') === '79b2314a08b7168dd8e1640b5ed80b2582c6117cbf1fb45b0f75fdbc7f0f62f0'
    }
     ...
     * # </weight>
     */
    get asV81(): {threshold: number, proposal: v81.Call, lengthBound: number} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Council.propose') === '4b795db388e994addf851a5ab1202bfa784aa7a7649941e55d998104c0118949'
    }
     ...
     * # </weight>
     */
    get asV87(): {threshold: number, proposal: v87.Call, lengthBound: number} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CouncilSetMembersCall {
     ...
     * # </weight>
     */
    get asV42(): {newMembers: Uint8Array[], prime: (Uint8Array | undefined), oldCount: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CouncilVoteCall {
     ...
     * # </weight>
     */
    get asV42(): {proposal: Uint8Array, index: number, approve: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CurrenciesTransferCall {
     ...
     * transactor.
     */
    get asV42(): {dest: Uint8Array, currencyId: number, amount: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CurrenciesTransferNativeCurrencyCall {
     ...
     * transactor.
     */
    get asV42(): {dest: Uint8Array, amount: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class CurrenciesUpdateBalanceCall {
     ...
     * The dispatch origin of this call must be _Root_.
     */
    get asV42(): {who: Uint8Array, currencyId: number, amount: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyBlacklistCall {
     ...
     *   reasonable value).
     */
    get asV42(): {proposalHash: Uint8Array, maybeRefIndex: (number | undefined)} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyDelegateCall {
     ...
     *   voted on. Weight is charged as if maximum votes.
     */
    get asV42(): {to: Uint8Array, conviction: v42.Conviction, balance: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyEnactProposalCall {
     ...
     * Enact a proposal from a referendum. For now we just make the weight be the maximum.
     */
    get asV42(): {proposalHash: Uint8Array, index: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyFastTrackCall {
     ...
     * Weight: `O(1)`
     */
    get asV42(): {proposalHash: Uint8Array, votingPeriod: number, delay: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyNoteImminentPreimageCall {
     ...
     * Weight: `O(E)` with E size of `encoded_proposal` (protected by a required deposit).
     */
    get asV42(): {encodedProposal: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyProposeCall {
     ...
     * Weight: `O(p)`
     */
    get asV42(): {proposalHash: Uint8Array, value: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyReapPreimageCall {
     ...
     * Weight: `O(D)` where D is length of proposal.
     */
    get asV42(): {proposalHash: Uint8Array, proposalLenUpperBound: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracyRemoveOtherVoteCall {
     ...
     *   Weight is calculated for the maximum number of vote.
     */
    get asV42(): {target: Uint8Array, index: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DemocracySecondCall {
     ...
     * Weight: `O(S)` where S is the number of seconds a proposal already has.
     */
    get asV42(): {proposal: number, secondsUpperBound: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DmpQueueServiceOverweightCall {
     ...
     * - `OverweightServiced`: On success.
     */
    get asV42(): {index: bigint, weightLimit: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * - `OverweightServiced`: On success.
     */
    get asV81(): {index: bigint, weightLimit: v81.Weight} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class DusterDustAccountCall {
     ...
     * Caller is rewarded with chosen reward in native currency.
     */
    get asV42(): {account: Uint8Array, currencyId: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ElectionsCleanDefunctVotersCall {
     ...
     * # </weight>
     */
    get asV42(): {numVoters: number, numDefunct: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ElectionsRemoveMemberCall {
     ...
     * # </weight>
     */
    get asV42(): {who: Uint8Array, hasReplacement: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV81(): {who: Uint8Array, slashBond: boolean, rerunElection: boolean} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ElectionsRenounceCandidacyCall {
     ...
     * # </weight>
     */
    get asV42(): {renouncing: v42.Renouncing} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ElectionsSubmitCandidacyCall {
     ...
     * # </weight>
     */
    get asV42(): {candidateCount: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ElectionsVoteCall {
     ...
     * # </weight>
     */
    get asV42(): {votes: Uint8Array[], value: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ExchangeBuyCall {
     ...
     * Calculate current spot price, create an intention and store in ```ExchangeAssetsIntentions```
     */
    get asV42(): {assetBuy: number, assetSell: number, amountBuy: bigint, maxSold: bigint, discount: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ExchangeSellCall {
     ...
     * Calculate current spot price, create an intention and store in ```ExchangeAssetsIntentions```
     */
    get asV42(): {assetSell: number, assetBuy: number, amountSell: bigint, minBought: bigint, discount: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LbpAddLiquidityCall {
     ...
     * Emits `LiquidityAdded` event when successful.
     */
    get asV42(): {amountA: [number, bigint], amountB: [number, bigint]} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LbpBuyCall {
     ...
     * Emits `BuyExecuted` when successful.
     */
    get asV42(): {assetOut: number, assetIn: number, amount: bigint, maxLimit: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LbpCreatePoolCall {
     ...
     * previously illiquid assets.
     */
    get asV42(): {poolOwner: Uint8Array, assetA: number, assetAAmount: bigint, assetB: number, assetBAmount: bigint, initialWeight: number, finalWeight: number, weightCurve: v42.WeightCurveType, fee: [number, number], feeCollector: Uint8Array, repayTarget: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LbpSellCall {
     ...
     * Emits `SellExecuted` when successful.
     */
    get asV42(): {assetIn: number, assetOut: number, amount: bigint, maxLimit: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LbpUpdatePoolDataCall {
     ...
     * Emits `PoolUpdated` event when successful.
     */
    get asV42(): {poolId: Uint8Array, poolOwner: (Uint8Array | undefined), start: (number | undefined), end: (number | undefined), initialWeight: (number | undefined), finalWeight: (number | undefined), fee: ([number, number] | undefined), feeCollector: (Uint8Array | undefined), repayTarget: (bigint | undefined)} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LiquidityMiningAddLiquidityPoolCall {
     ...
     * Emits `LiquidityPoolAdded` event when successful.
     */
    get asV42(): {farmId: number, assetPair: v42.AssetPair, multiplier: bigint, loyaltyCurve: (v42.LoyaltyCurve | undefined)} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LiquidityMiningCancelLiquidityPoolCall {
     ...
     * Emits `LiquidityMiningCanceled` event when successful.
     */
    get asV42(): {farmId: number, assetPair: v42.AssetPair} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LiquidityMiningCreateFarmCall {
     ...
     * Emits `FarmCreated` event when successful.
     */
    get asV42(): {totalRewards: bigint, plannedYieldingPeriods: number, blocksPerPeriod: number, incentivizedAsset: number, rewardCurrency: number, owner: Uint8Array, yieldPerPeriod: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LiquidityMiningDepositSharesCall {
     ...
     * Emits `SharesDeposited` event when successful.
     */
    get asV42(): {farmId: number, assetPair: v42.AssetPair, sharesAmount: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class LiquidityMiningResumeLiquidityPoolCall {
     ...
     * Emits `LiquidityMiningResumed` event when successful.
     */
    get asV42(): {farmId: number, assetPair: v42.AssetPair, multiplier: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceAcceptOfferCall {
     ...
     * - `maker`: User who made the offer
     */
    get asV42(): {classId: bigint, instanceId: bigint, maker: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Marketplace.accept_offer') === 'ebe2b00c137c7ab0962c9af9dd5160ca27dd77d9df87cdd57fec0d934cc975ff'
    }
     ...
     * - `maker`: User who made the offer
     */
    get asV81(): {collectionId: bigint, itemId: bigint, maker: Uint8Array} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceAddRoyaltyCall {
     ...
     * - `royalty`: Percentage reward from each trade for the author
     */
    get asV42(): {classId: bigint, instanceId: bigint, author: Uint8Array, royalty: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * - `royalty`: Percentage reward from each trade for the author, represented in basis points
     */
    get asV75(): {classId: bigint, instanceId: bigint, author: Uint8Array, royalty: number} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Marketplace.add_royalty') === '66aec3ca29b6c6384cfc70eba82f854ab9ecbae4d580251a8b69e5b5f89043c9'
    }
     ...
     * - `royalty`: Percentage reward from each trade for the author, represented in basis points
     */
    get asV81(): {collectionId: bigint, itemId: bigint, author: Uint8Array, royalty: number} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceBuyCall {
     ...
     * - `instance_id`: The instance identifier of a class
     */
    get asV42(): {classId: bigint, instanceId: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Marketplace.buy') === '0d81e84b66fd2e476077c345167ddee631d8a5dd12872866736d656e2060d8cd'
    }
     ...
     * - `item_id`: The item identifier of a collection
     */
    get asV81(): {collectionId: bigint, itemId: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceMakeOfferCall {
     ...
     * - `expires`: The block until the current owner can accept the offer
     */
    get asV42(): {classId: bigint, instanceId: bigint, amount: bigint, expires: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Marketplace.make_offer') === 'e619c8b41adf6350d3793198eaf8e6b5663f223a546d0944db9e95dce9c5fced'
    }
     ...
     * - `expires`: The block until the current owner can accept the offer
     */
    get asV81(): {collectionId: bigint, itemId: bigint, amount: bigint, expires: number} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceSetPriceCall {
     ...
     * - `new_price`: price the token will be listed for
     */
    get asV42(): {classId: bigint, instanceId: bigint, newPrice: (bigint | undefined)} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Marketplace.set_price') === '7d82ce731198aa0545ad77fa04b806c0ccc1af7b9fcdd2c38d1013295c714e6e'
    }
     ...
     * - `new_price`: price the token will be listed for
     */
    get asV81(): {collectionId: bigint, itemId: bigint, newPrice: (bigint | undefined)} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MarketplaceWithdrawOfferCall {
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Marketplace.withdraw_offer') === 'ebe2b00c137c7ab0962c9af9dd5160ca27dd77d9df87cdd57fec0d934cc975ff'
    }
...
export class MultiTransactionPaymentAddCurrencyCall {
     ...
     * Emits `CurrencyAdded` event when successful.
     */
    get asV42(): {currency: number, price: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultisigApproveAsMultiCall {
     ...
     * # </weight>
     */
    get asV81(): {threshold: number, otherSignatories: Uint8Array[], maybeTimepoint: (v81.Timepoint | undefined), callHash: Uint8Array, maxWeight: v81.Weight} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultisigAsMultiCall {
     ...
     * # </weight>
     */
    get asV81(): {threshold: number, otherSignatories: Uint8Array[], maybeTimepoint: (v81.Timepoint | undefined), call: Uint8Array, storeCall: boolean, maxWeight: v81.Weight} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class MultisigAsMultiThreshold1Call {
     ...
     * # </weight>
     */
    get asV62(): {otherSignatories: Uint8Array[], call: v62.Call} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Multisig.as_multi_threshold_1') === '796da816298bf4a96e0e2f6ff6d394f0f94a9ef025c204936351834962f525e3'
    }
     ...
     * # </weight>
     */
    get asV67(): {otherSignatories: Uint8Array[], call: v67.Call} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV75(): {otherSignatories: Uint8Array[], call: v75.Call} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Multisig.as_multi_threshold_1') === '93ae10381b1503a82de32334c88809c69d193fb16b74f6954f6828f1fdf3b4b5'
    }
     ...
     * # </weight>
     */
    get asV81(): {otherSignatories: Uint8Array[], call: v81.Call} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Multisig.as_multi_threshold_1') === 'b33ae259e4c8e5de839631b7abd92a32b038680b9ed8302da7b84ef497ec8361'
    }
     ...
     * # </weight>
     */
    get asV87(): {otherSignatories: Uint8Array[], call: v87.Call} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class NftBurnCall {
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('NFT.burn') === '0d81e84b66fd2e476077c345167ddee631d8a5dd12872866736d656e2060d8cd'
    }
...
export class NftCreateClassCall {
     ...
     * Emits ClassCreated event
     */
    get asV42(): {classId: bigint, classType: v42.ClassType, metadata: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}

export class NftCreateCollectionCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'NFT.create_collection')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('NFT.create_collection') === 'f59627a2d512128be2381042bbab7cb6b6f41872e17efb3b5f93690996b63c2a'
    }
     ...
     * Emits CollectionCreated event
     */
    get asV81(): {collectionId: bigint, collectionType: v81.CollectionType, metadata: Uint8Array} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class NftDestroyClassCall {
     ...
     * - `class_id`: The identifier of the asset class to be destroyed.
     */
    get asV42(): {classId: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}

export class NftDestroyCollectionCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'NFT.destroy_collection')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('NFT.destroy_collection') === '057e325ebb04166081a2c8cd2cc1f2a50181d12678c5d261d3e70e3fe9252db3'
    }
...
export class NftMintCall {
     ...
     * - `metadata`: Arbitrary data about an instance, e.g. IPFS hash or symbol
     */
    get asV42(): {classId: bigint, instanceId: bigint, metadata: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('NFT.mint') === 'ba9bc0c95ae68f9ef4eecb80aa87afe1acee344997788a4d2c9498861282321e'
    }
     ...
     * - `metadata`: Arbitrary data about an item, e.g. IPFS hash or symbol
     */
    get asV81(): {collectionId: bigint, itemId: bigint, metadata: Uint8Array} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class NftTransferCall {
     ...
     * - `dest`: The account to receive ownership of the asset.
     */
    get asV42(): {classId: bigint, instanceId: bigint, dest: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('NFT.transfer') === '28d3d58211b3054bea184bd06194a5935d7840ab94fb11c9850e5d4def777eca'
    }
     ...
     * - `dest`: The account to receive ownership of the asset.
     */
    get asV81(): {collectionId: bigint, itemId: bigint, dest: Uint8Array} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class OrmlXcmSendAsSovereignCall {
     ...
     * Send an XCM message as parachain sovereign.
     */
    get asV42(): {dest: v42.VersionedMultiLocation, message: v42.VersionedXcm} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ParachainSystemSetValidationDataCall {
     ...
     * if the appropriate time has come.
     */
    get asV42(): {data: v42.ParachainInherentData} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class PolkadotXcmExecuteCall {
     ...
     * to completion; only that *some* of it was executed.
     */
    get asV42(): {message: v42.Type_236, maxWeight: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * to completion; only that *some* of it was executed.
     */
    get asV81(): {message: v81.Type_286, maxWeight: v81.Weight} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class PolkadotXcmForceDefaultXcmVersionCall {
     ...
     * - `maybe_xcm_version`: The default XCM encoding version, or `None` to disable.
     */
    get asV42(): {maybeXcmVersion: (number | undefined)} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class PolkadotXcmForceSubscribeVersionNotifyCall {
     ...
     * - `location`: The location to which we should subscribe for XCM version notifications.
     */
    get asV42(): {location: v42.VersionedMultiLocation} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class PolkadotXcmForceXcmVersionCall {
     ...
     * - `xcm_version`: The latest version of XCM that `location` supports.
     */
    get asV42(): {location: v42.V1MultiLocation, xcmVersion: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class PolkadotXcmLimitedReserveTransferAssetsCall {
     ...
     * - `weight_limit`: The remote-side weight limit, if any, for the XCM fee purchase.
     */
    get asV42(): {dest: v42.VersionedMultiLocation, beneficiary: v42.VersionedMultiLocation, assets: v42.VersionedMultiAssets, feeAssetItem: number, weightLimit: v42.V2WeightLimit} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class PolkadotXcmReserveTransferAssetsCall {
     ...
     *   fees.
     */
    get asV42(): {dest: v42.VersionedMultiLocation, beneficiary: v42.VersionedMultiLocation, assets: v42.VersionedMultiAssets, feeAssetItem: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ProxyAddProxyCall {
     ...
     * # </weight>
     */
    get asV42(): {delegate: Uint8Array, proxyType: v42.ProxyType, delay: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ProxyAnnounceCall {
     ...
     * # </weight>
     */
    get asV42(): {real: Uint8Array, callHash: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ProxyAnonymousCall {
     ...
     * TODO: Might be over counting 1 read
     */
    get asV42(): {proxyType: v42.ProxyType, delay: number, index: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ProxyKillAnonymousCall {
     ...
     * # </weight>
     */
    get asV42(): {spawner: Uint8Array, proxyType: v42.ProxyType, index: number, height: number, extIndex: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ProxyProxyCall {
     ...
     * # </weight>
     */
    get asV42(): {real: Uint8Array, forceProxyType: (v42.ProxyType | undefined), call: v42.Call} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV62(): {real: Uint8Array, forceProxyType: (v62.ProxyType | undefined), call: v62.Call} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Proxy.proxy') === '166e6e43f37777c7703f93d37f5ea6dbe4fc232366e367b371e7d434a519b6b8'
    }
     ...
     * # </weight>
     */
    get asV67(): {real: Uint8Array, forceProxyType: (v67.ProxyType | undefined), call: v67.Call} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV68(): {real: Uint8Array, forceProxyType: (v68.ProxyType | undefined), call: v68.Call} {
        assert(this.isV68)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV75(): {real: Uint8Array, forceProxyType: (v75.ProxyType | undefined), call: v75.Call} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Proxy.proxy') === '7af62b5f69b3b16f0be899ae15760dbfa6cbe685d1cb6d2a3293daa59071f272'
    }
     ...
     * # </weight>
     */
    get asV81(): {real: Uint8Array, forceProxyType: (v81.ProxyType | undefined), call: v81.Call} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Proxy.proxy') === '05017ee6403fd92b26f7c9a1544847cdaac39f5ad81d9df80665f7af2847600c'
    }
     ...
     * # </weight>
     */
    get asV87(): {real: Uint8Array, forceProxyType: (v87.ProxyType | undefined), call: v87.Call} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ProxyProxyAnnouncedCall {
     ...
     * # </weight>
     */
    get asV42(): {delegate: Uint8Array, real: Uint8Array, forceProxyType: (v42.ProxyType | undefined), call: v42.Call} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV62(): {delegate: Uint8Array, real: Uint8Array, forceProxyType: (v62.ProxyType | undefined), call: v62.Call} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Proxy.proxy_announced') === 'c9e7f038e12bd5edd7205d582d2139387679ff5f1858843534dbd34f86c5951a'
    }
     ...
     * # </weight>
     */
    get asV67(): {delegate: Uint8Array, real: Uint8Array, forceProxyType: (v67.ProxyType | undefined), call: v67.Call} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV68(): {delegate: Uint8Array, real: Uint8Array, forceProxyType: (v68.ProxyType | undefined), call: v68.Call} {
        assert(this.isV68)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV75(): {delegate: Uint8Array, real: Uint8Array, forceProxyType: (v75.ProxyType | undefined), call: v75.Call} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Proxy.proxy_announced') === '1cab60491e06e770e61e51939d26080c5515d6d95f7c1619a7c3f5e7b31e8d2f'
    }
     ...
     * # </weight>
     */
    get asV81(): {delegate: Uint8Array, real: Uint8Array, forceProxyType: (v81.ProxyType | undefined), call: v81.Call} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Proxy.proxy_announced') === '1646b37b6bd3de8a156a0bc4f27100ce88499364f477c3f7a815cc1bc0a7d70c'
    }
     ...
     * # </weight>
     */
    get asV87(): {delegate: Uint8Array, real: Uint8Array, forceProxyType: (v87.ProxyType | undefined), call: v87.Call} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class ProxyRejectAnnouncementCall {
     ...
     * # </weight>
     */
    get asV42(): {delegate: Uint8Array, callHash: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class RouterBuyCall {
     ...
     * Emits `RouteExecuted` when successful.
     */
    get asV75(): {assetIn: number, assetOut: number, amountOut: bigint, maxAmountIn: bigint, route: v75.Trade[]} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Router.buy') === '8edf453178b6f49349bcd17890cb0bcc0fd1306131c439f0f8559e2be4484417'
    }
     ...
     * Emits `RouteExecuted` when successful.
     */
    get asV81(): {assetIn: number, assetOut: number, amountOut: bigint, maxAmountIn: bigint, route: v81.Trade[]} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class RouterSellCall {
     ...
     * Emits `RouteExecuted` when successful.
     */
    get asV75(): {assetIn: number, assetOut: number, amountIn: bigint, minAmountOut: bigint, route: v75.Trade[]} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Router.sell') === '5af792981b0cccd3aad8144967a6b9e7a602f291ce9d8f1cbd4a2d90a6f7f474'
    }
     ...
     * Emits `RouteExecuted` when successful.
     */
    get asV81(): {assetIn: number, assetOut: number, amountIn: bigint, minAmountOut: bigint, route: v81.Trade[]} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SchedulerScheduleCall {
     ...
     * Anonymously schedule a task.
     */
    get asV62(): {when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v62.MaybeHashed} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Scheduler.schedule') === 'ed9107faf687696c6fab5cf52cd35620537117aa73beb7dbcc2fc91bfc653e8c'
    }

    /**
     * Anonymously schedule a task.
     */
    get asV67(): {when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v67.MaybeHashed} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Anonymously schedule a task.
     */
    get asV68(): {when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v68.MaybeHashed} {
        assert(this.isV68)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Anonymously schedule a task.
     */
    get asV75(): {when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v75.MaybeHashed} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Scheduler.schedule') === '50022e91aa3ea1fbd92d17fb560ddcd5d411325a3391549dce90c8b16c340e5c'
    }

    /**
     * Anonymously schedule a task.
     */
    get asV81(): {when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v81.MaybeHashed} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Scheduler.schedule') === '86546c2c76be3f1784eaedea812859ef998cb3db6bf36d6eb4e97d5765802da7'
    }

    /**
     * Anonymously schedule a task.
     */
    get asV87(): {when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v87.MaybeHashed} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SchedulerScheduleAfterCall {
     ...
     * # </weight>
     */
    get asV62(): {after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v62.MaybeHashed} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_after') === '4180f3cb7dcda9e58a4293b4932d5495b57a17749d98b09fef06a054f2817f7c'
    }
     ...
     * # </weight>
     */
    get asV67(): {after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v67.MaybeHashed} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV68(): {after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v68.MaybeHashed} {
        assert(this.isV68)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV75(): {after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v75.MaybeHashed} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_after') === '23dd192fb50207be81edb9691d23d53f57c968743688843630befd3df94d5777'
    }
     ...
     * # </weight>
     */
    get asV81(): {after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v81.MaybeHashed} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_after') === '1219362f7645c14a06033ee4fcf2b97497edab0e5069ba5e2f3458972c6ba49d'
    }
     ...
     * # </weight>
     */
    get asV87(): {after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v87.MaybeHashed} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SchedulerScheduleNamedCall {
     ...
     * Schedule a named task.
     */
    get asV62(): {id: Uint8Array, when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v62.MaybeHashed} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_named') === '7f8705180a9e379b0e3adc6241f0d93fc2ceb1d24583b11d04135fac9671b9d9'
    }

    /**
     * Schedule a named task.
     */
    get asV67(): {id: Uint8Array, when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v67.MaybeHashed} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Schedule a named task.
     */
    get asV68(): {id: Uint8Array, when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v68.MaybeHashed} {
        assert(this.isV68)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Schedule a named task.
     */
    get asV75(): {id: Uint8Array, when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v75.MaybeHashed} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_named') === 'c582cfc7090719a2db2d76e697993ea4fb5440c7c532d5d5170926dd68140d3e'
    }

    /**
     * Schedule a named task.
     */
    get asV81(): {id: Uint8Array, when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v81.MaybeHashed} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_named') === 'c95474a5ceec4d0ace23381cd50bf3b89dab68f0280fc5f058036d8416323fb9'
    }

    /**
     * Schedule a named task.
     */
    get asV87(): {id: Uint8Array, when: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v87.MaybeHashed} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SchedulerScheduleNamedAfterCall {
     ...
     * # </weight>
     */
    get asV62(): {id: Uint8Array, after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v62.MaybeHashed} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_named_after') === 'a9ed48c085fd368bd73828a3ec969cf344f4ecffc4a57665e3987dfc1b6031fd'
    }
     ...
     * # </weight>
     */
    get asV67(): {id: Uint8Array, after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v67.MaybeHashed} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV68(): {id: Uint8Array, after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v68.MaybeHashed} {
        assert(this.isV68)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV75(): {id: Uint8Array, after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v75.MaybeHashed} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_named_after') === '2145765902614d7383c0cb6af393045cd7647ed3e0a0a54b4a355d8599eb6815'
    }
     ...
     * # </weight>
     */
    get asV81(): {id: Uint8Array, after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v81.MaybeHashed} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Scheduler.schedule_named_after') === '53da8abbaf5216a43a34561c8da355276eb7af29a73439866bc7ee6ff5a9aaf6'
    }
     ...
     * # </weight>
     */
    get asV87(): {id: Uint8Array, after: number, maybePeriodic: ([number, number] | undefined), priority: number, call: v87.MaybeHashed} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SudoSudoAsCall {
     ...
     * # </weight>
     */
    get asV62(): {who: Uint8Array, call: v62.Call} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SudoSudoUncheckedWeightCall {
     ...
     * # </weight>
     */
    get asV62(): {call: v62.Call, weight: bigint} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SystemKillPrefixCall {
     ...
     * the prefix we are removing to accurately calculate the weight of this function.
     */
    get asV42(): {prefix: Uint8Array, subkeys: number} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class SystemSetStorageCall {
     ...
     * Set some items of storage.
     */
    get asV42(): {items: [Uint8Array, Uint8Array][]} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TechnicalCommitteeExecuteCall {
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('TechnicalCommittee.execute') === 'f756b392f95bfba3c3f5b5f0652c2b8406be94906e250d6cb553f747ad24cf8f'
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('TechnicalCommittee.execute') === 'daaddcbca6e5e200c607d9589180f49d3d31e97ab2de63fd36c1ffd97d46dd10'
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('TechnicalCommittee.execute') === 'b2b1c0e7f4511d93a6a32b97710c181e354b364fa4ebc6ca92f4dfbb24b71857'
    }
...
export class TechnicalCommitteeProposeCall {
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('TechnicalCommittee.propose') === 'dabafe4da08f584ad7756291939b11a8311a6dc59d804a2c765fca7d48f6e795'
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('TechnicalCommittee.propose') === '79b2314a08b7168dd8e1640b5ed80b2582c6117cbf1fb45b0f75fdbc7f0f62f0'
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('TechnicalCommittee.propose') === '4b795db388e994addf851a5ab1202bfa784aa7a7649941e55d998104c0118949'
    }
...
export class TipsReportAwesomeCall {
     ...
     * # </weight>
     */
    get asV42(): {reason: Uint8Array, who: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TipsTipCall {
     ...
     * # </weight>
     */
    get asV42(): {hash: Uint8Array, tipValue: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TipsTipNewCall {
     ...
     * # </weight>
     */
    get asV42(): {reason: Uint8Array, who: Uint8Array, tipValue: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TokensForceTransferCall {
     ...
     * - `amount`: free balance amount to tranfer.
     */
    get asV42(): {source: Uint8Array, dest: Uint8Array, currencyId: number, amount: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TokensSetBalanceCall {
     ...
     * The dispatch origin for this call is `root`.
     */
    get asV42(): {who: Uint8Array, currencyId: number, newFree: bigint, newReserved: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TokensTransferAllCall {
     ...
     *   keep the sender account alive (true).
     */
    get asV42(): {dest: Uint8Array, currencyId: number, keepAlive: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TransactionPausePauseTransactionCall {
    ...
    get asV62(): {palletName: Uint8Array, functionName: Uint8Array} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TreasuryProposeSpendCall {
     ...
     * # </weight>
     */
    get asV42(): {value: bigint, beneficiary: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class TreasurySpendCall {
     ...
     * beneficiary.
     */
    get asV81(): {amount: bigint, beneficiary: Uint8Array} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesApproveTransferCall {
     ...
     * Weight: `O(1)`
     */
    get asV42(): {class: bigint, instance: bigint, delegate: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Weight: `O(1)`
     */
    get asV81(): {collection: bigint, item: bigint, delegate: Uint8Array} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesBurnCall {
     ...
     * Modes: `check_owner.is_some()`.
     */
    get asV42(): {class: bigint, instance: bigint, checkOwner: (Uint8Array | undefined)} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Modes: `check_owner.is_some()`.
     */
    get asV81(): {collection: bigint, item: bigint, checkOwner: (Uint8Array | undefined)} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesBuyItemCall {
     ...
     * Emits `ItemBought` on success.
     */
    get asV81(): {collection: bigint, item: bigint, bidPrice: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesCancelApprovalCall {
     ...
     * Weight: `O(1)`
     */
    get asV42(): {class: bigint, instance: bigint, maybeCheckDelegate: (Uint8Array | undefined)} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Weight: `O(1)`
     */
    get asV81(): {collection: bigint, item: bigint, maybeCheckDelegate: (Uint8Array | undefined)} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesCreateCall {
     ...
     * Weight: `O(1)`
     */
    get asV42(): {class: bigint, admin: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Weight: `O(1)`
     */
    get asV81(): {collection: bigint, admin: Uint8Array} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesDestroyCall {
     ...
     * - `a = witness.attributes`
     */
    get asV42(): {class: bigint, witness: v42.DestroyWitness} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * - `a = witness.attributes`
     */
    get asV81(): {collection: bigint, witness: v81.DestroyWitness} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesForceAssetStatusCall {
     ...
     * Weight: `O(1)`
     */
    get asV42(): {class: bigint, owner: Uint8Array, issuer: Uint8Array, admin: Uint8Array, freezer: Uint8Array, freeHolding: boolean, isFrozen: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesForceCreateCall {
     ...
     * Weight: `O(1)`
     */
    get asV42(): {class: bigint, owner: Uint8Array, freeHolding: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Weight: `O(1)`
     */
    get asV81(): {collection: bigint, owner: Uint8Array, freeHolding: boolean} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesForceItemStatusCall {
     ...
     * Weight: `O(1)`
     */
    get asV81(): {collection: bigint, owner: Uint8Array, issuer: Uint8Array, admin: Uint8Array, freezer: Uint8Array, freeHolding: boolean, isFrozen: boolean} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesRedepositCall {
     ...
     * Weight: `O(instances.len())`
     */
    get asV42(): {class: bigint, instances: bigint[]} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Weight: `O(items.len())`
     */
    get asV81(): {collection: bigint, items: bigint[]} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesSetAcceptOwnershipCall {
     ...
     * Emits `OwnershipAcceptanceChanged`.
     */
    get asV81(): {maybeCollection: (bigint | undefined)} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesSetPriceCall {
     ...
     * Emits `ItemPriceRemoved` on success if the price is `None`.
     */
    get asV81(): {collection: bigint, item: bigint, price: (bigint | undefined), whitelistedBuyer: (Uint8Array | undefined)} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UniquesTransferCall {
     ...
     * Weight: `O(1)`
     */
    get asV42(): {class: bigint, instance: bigint, dest: Uint8Array} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     * Weight: `O(1)`
     */
    get asV81(): {collection: bigint, item: bigint, dest: Uint8Array} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UtilityAsDerivativeCall {
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    get asV62(): {index: number, call: v62.Call} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Utility.as_derivative') === '0facd928c595605d212f65caa8032b317590255d07374bdc5bea3848bb7c30b7'
    }
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    get asV67(): {index: number, call: v67.Call} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    get asV75(): {index: number, call: v75.Call} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Utility.as_derivative') === 'a89e77be127775751a0bb2f1c7d42cde3744bec41686f847a9bc23700ceee01e'
    }
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    get asV81(): {index: number, call: v81.Call} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Utility.as_derivative') === '78013cafcf5caf393467ee95b04d11edc2f9ee37a5ef51d0e467072e87e6c252'
    }
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    get asV87(): {index: number, call: v87.Call} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UtilityBatchCall {
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Utility.batch') === '212e8047049c0299212615cfa29139d27aa89db3285ef2a95b91cba3ad01b0a0'
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Utility.batch') === 'd6b793a66d00edf1a5815b9d5ad09ca73c4786ddbc10ce7ef66c2aa967ff3ac0'
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Utility.batch') === '73a04ed5ea2f3070878c4cb70a513515841f6426ff3d0b63bb2bd0698c67ad35'
    }
...
export class UtilityBatchAllCall {
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Utility.batch_all') === '212e8047049c0299212615cfa29139d27aa89db3285ef2a95b91cba3ad01b0a0'
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Utility.batch_all') === 'd6b793a66d00edf1a5815b9d5ad09ca73c4786ddbc10ce7ef66c2aa967ff3ac0'
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Utility.batch_all') === '73a04ed5ea2f3070878c4cb70a513515841f6426ff3d0b63bb2bd0698c67ad35'
    }
...
export class UtilityDispatchAsCall {
     ...
     * # </weight>
     */
    get asV62(): {asOrigin: v62.OriginCaller, call: v62.Call} {
        assert(this.isV62)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV67(): boolean {
        return this._chain.getCallHash('Utility.dispatch_as') === '0266da1f9a62a9c5c704a3c7a9a7273617ee73d87448a40e496d33fb1ae13360'
    }
     ...
     * # </weight>
     */
    get asV67(): {asOrigin: v67.OriginCaller, call: v67.Call} {
        assert(this.isV67)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV75(): {asOrigin: v75.OriginCaller, call: v75.Call} {
        assert(this.isV75)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Utility.dispatch_as') === '32be56d6ac8125069c5241a11b60c121b3d7a414158f52d806f2c64b1e459083'
    }
     ...
     * # </weight>
     */
    get asV81(): {asOrigin: v81.OriginCaller, call: v81.Call} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Utility.dispatch_as') === 'a0385fc50d2b04badaed69cd783ff5f451c96508024c84912ab66171cb1cfff1'
    }
     ...
     * # </weight>
     */
    get asV87(): {asOrigin: v87.OriginCaller, call: v87.Call} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}
...
export class UtilityForceBatchCall {
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('Utility.force_batch') === 'd6b793a66d00edf1a5815b9d5ad09ca73c4786ddbc10ce7ef66c2aa967ff3ac0'
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('Utility.force_batch') === '73a04ed5ea2f3070878c4cb70a513515841f6426ff3d0b63bb2bd0698c67ad35'
    }
...
export class VestingUpdateVestingSchedulesCall {
    ...
    get asV42(): {who: Uint8Array, vestingSchedules: v42.VestingSchedule[]} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class VestingVestedTransferCall {
    ...
    get asV42(): {dest: Uint8Array, schedule: v42.VestingSchedule} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferCall {
     ...
     * messages correctly.
     */
    get asV42(): {currencyId: number, amount: bigint, dest: v42.VersionedMultiLocation, destWeight: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferMultiassetCall {
     ...
     * messages correctly.
     */
    get asV42(): {asset: v42.VersionedMultiAsset, dest: v42.VersionedMultiLocation, destWeight: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferMultiassetWithFeeCall {
     ...
     * messages correctly.
     */
    get asV42(): {asset: v42.VersionedMultiAsset, fee: v42.VersionedMultiAsset, dest: v42.VersionedMultiLocation, destWeight: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferMultiassetsCall {
     ...
     * messages correctly.
     */
    get asV42(): {assets: v42.VersionedMultiAssets, feeItem: number, dest: v42.VersionedMultiLocation, destWeight: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferMulticurrenciesCall {
     ...
     * messages correctly.
     */
    get asV42(): {currencies: [number, bigint][], feeItem: number, dest: v42.VersionedMultiLocation, destWeight: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XTokensTransferWithFeeCall {
     ...
     * messages correctly.
     */
    get asV42(): {currencyId: number, amount: bigint, fee: bigint, dest: v42.VersionedMultiLocation, destWeight: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XykAddLiquidityCall {
     ...
     * Emits `LiquidityAdded` event when successful.
     */
    get asV42(): {assetA: number, assetB: number, amountA: bigint, amountBMaxLimit: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XykBuyCall {
     ...
     * Emits `BuyExecuted` when successful.
     */
    get asV42(): {assetOut: number, assetIn: number, amount: bigint, maxLimit: bigint, discount: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XykCreatePoolCall {
     ...
     * Emits `PoolCreated` event when successful.
     */
    get asV42(): {assetA: number, assetB: number, amount: bigint, initialPrice: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYK.create_pool') === 'c97261fd6be17418ea2e258a1ae12be52d2b29a4904004c77a46f17052a83377'
    }
     ...
     * Emits `PoolCreated` event when successful.
     */
    get asV81(): {assetA: number, amountA: bigint, assetB: number, amountB: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XykRemoveLiquidityCall {
     ...
     * Emits 'PoolDestroyed' when pool is destroyed.
     */
    get asV42(): {assetA: number, assetB: number, liquidityAmount: bigint} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}
...
export class XykSellCall {
     ...
     * Emits `SellExecuted` when successful.
     */
    get asV42(): {assetIn: number, assetOut: number, amount: bigint, maxLimit: bigint, discount: boolean} {
        assert(this.isV42)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningClaimRewardsCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.claim_rewards')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.claim_rewards') === '5277dbfabb0aaf11ff64e071320b401ab304d1054c363f2e24cf48c054f58a95'
    }
     ...
     * Emits `RewardClaimed` event when successful.
     */
    get asV81(): {depositId: bigint, yieldFarmId: number} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningCreateGlobalFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.create_global_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.create_global_farm') === 'd28662e616a18fcf004ecc8f28bccba8290de8c5bd07d539acaa3948d688edee'
    }
     ...
     * Emits `GlobalFarmCreated` event when successful.
     */
    get asV81(): {totalRewards: bigint, plannedYieldingPeriods: number, blocksPerPeriod: number, incentivizedAsset: number, rewardCurrency: number, owner: Uint8Array, yieldPerPeriod: bigint, minDeposit: bigint, priceAdjustment: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningCreateYieldFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.create_yield_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.create_yield_farm') === '3764d935600f3f7ba68069bc5934c83a17be187e2026bf9735a8c163e64c69f1'
    }
     ...
     * Emits `YieldFarmCreated` event when successful.
     */
    get asV81(): {globalFarmId: number, assetPair: v81.AssetPair, multiplier: bigint, loyaltyCurve: (v81.LoyaltyCurve | undefined)} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningDepositSharesCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.deposit_shares')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.deposit_shares') === '7d300d5670217fb959619722b07af29f8b421d4a02ed1d3e374898c606b8799f'
    }
     ...
     * Emits `SharesDeposited` event when successful.
     */
    get asV81(): {globalFarmId: number, yieldFarmId: number, assetPair: v81.AssetPair, sharesAmount: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningDestroyGlobalFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.destroy_global_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.destroy_global_farm') === '6c81d62dc35d0454853f5260a9937f1dea716b76a958a096c5baa5a1f4a88cce'
    }
     ...
     * Emits `FarmDestroyed` event when successful.
     */
    get asV81(): {globalFarmId: number} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningDestroyYieldFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.destroy_yield_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.destroy_yield_farm') === 'e1ac3cc4323322091808d1b441d6870a5bf2c20ad63e31a75bed9241fe6f4659'
    }
     ...
     * Emits `YieldFarmDestroyed` event when successful.
     */
    get asV81(): {globalFarmId: number, yieldFarmId: number, assetPair: v81.AssetPair} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningRedepositSharesCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.redeposit_shares')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.redeposit_shares') === '402a48d0de31989d5a524f33bddfac171886ca9cca98d38eca16037b331a0f2d'
    }
     ...
     * Emits `SharesRedeposited` event when successful.
     */
    get asV81(): {globalFarmId: number, yieldFarmId: number, assetPair: v81.AssetPair, depositId: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningResumeYieldFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.resume_yield_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.resume_yield_farm') === '7ac9b9a58a3a6934562c291fe12b7778dea22509fb10a82d6a03ac53cf2a5cb9'
    }
     ...
     * Emits `YieldFarmResumed` event when successful.
     */
    get asV81(): {globalFarmId: number, yieldFarmId: number, assetPair: v81.AssetPair, multiplier: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningStopYieldFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.stop_yield_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.stop_yield_farm') === 'f189257889d5c24a6c1cb015e6c1a368d73caea95a3d70678687ed34c05d8dca'
    }
     ...
     * Emits `YieldFarmStopped` event when successful.
     */
    get asV81(): {globalFarmId: number, assetPair: v81.AssetPair} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningTerminateGlobalFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.terminate_global_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.terminate_global_farm') === '6c81d62dc35d0454853f5260a9937f1dea716b76a958a096c5baa5a1f4a88cce'
    }
     ...
     * Emits `GlobalFarmTerminated` event when successful.
     */
    get asV87(): {globalFarmId: number} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningTerminateYieldFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.terminate_yield_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.terminate_yield_farm') === 'e1ac3cc4323322091808d1b441d6870a5bf2c20ad63e31a75bed9241fe6f4659'
    }
     ...
     * Emits `YieldFarmTerminated` event when successful.
     */
    get asV87(): {globalFarmId: number, yieldFarmId: number, assetPair: v87.AssetPair} {
        assert(this.isV87)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningUpdateGlobalFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.update_global_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.update_global_farm') === '41f86d61e9c33e480d32f5cb4bcfdd5e7ee331338d1f09206635ebff0fc41928'
    }
     ...
     * Emits `GlobalFarmUpdated` event when successful.
     */
    get asV81(): {globalFarmId: number, priceAdjustment: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningUpdateYieldFarmCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.update_yield_farm')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.update_yield_farm') === '647b2578519d41fae3326f77de284f10b059de7f8f70008f63d9dfcb1c56e7be'
    }
     ...
     * Emits `YieldFarmUpdated` event when successful.
     */
    get asV81(): {globalFarmId: number, assetPair: v81.AssetPair, multiplier: bigint} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}

export class XykLiquidityMiningWithdrawSharesCall {
    private readonly _chain: Chain
    private readonly call: Call
    ...
    constructor(ctx: CallContext, call?: Call) {
        call = call || ctx.call
        assert(call.name === 'XYKLiquidityMining.withdraw_shares')
        this._chain = ctx._chain
        this.call = call
    }
     ...
     */
    get isV81(): boolean {
        return this._chain.getCallHash('XYKLiquidityMining.withdraw_shares') === '2b87df4b27bd99dcc7664194bc99e1c0bd8c4c89fd0328d9a0ef8f2a07ec502e'
    }
     ...
     * * `SharesWithdrawn` event when successful
     */
    get asV81(): {depositId: bigint, yieldFarmId: number, assetPair: v81.AssetPair} {
        assert(this.isV81)
        return this._chain.decodeCall(this.call)
    }
}
