...
export type Type_315 = Type_315_Relay | Type_315_SiblingParachain

export interface Type_315_Relay {
  __kind: 'Relay'
}

export interface Type_315_SiblingParachain {
