...
export class XykLiquidityMiningGlobalFarmTerminatedEvent {
    private readonly _chain: Chain
    private readonly event: Event
    ...
    constructor(ctx: EventContext, event?: Event) {
        event = event || ctx.event
        assert(event.name === 'XYKLiquidityMining.GlobalFarmTerminated')
        this._chain = ctx._chain
        this.event = event
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getEventHash('XYKLiquidityMining.GlobalFarmTerminated') === '57232c821de61efc771f55d15a7327bd1404a9c025471193d7cdb83a99047d67'
    }

    /**
     * Global farm was terminated.
     */
    get asV87(): {globalFarmId: number, who: Uint8Array, rewardCurrency: number, undistributedRewards: bigint} {
        assert(this.isV87)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XykLiquidityMiningYieldFarmTerminatedEvent {
    private readonly _chain: Chain
    private readonly event: Event
    ...
    constructor(ctx: EventContext, event?: Event) {
        event = event || ctx.event
        assert(event.name === 'XYKLiquidityMining.YieldFarmTerminated')
        this._chain = ctx._chain
        this.event = event
    }
     ...
     */
    get isV87(): boolean {
        return this._chain.getEventHash('XYKLiquidityMining.YieldFarmTerminated') === '9d459d74d7f6e8346a3efb030d03ba9b500ac6cf80e5bd76f596a887c8c02af4'
    }

    /**
     * Yield farm was terminated from global farm.
     */
    get asV87(): {globalFarmId: number, yieldFarmId: number, who: Uint8Array, assetPair: v87.AssetPair} {
        assert(this.isV87)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class XykWarehouseLmAllRewardsDistributedEvent {
    private readonly _chain: Chain
    private readonly event: Event
    ...
    constructor(ctx: EventContext, event?: Event) {
        event = event || ctx.event
        assert(event.name === 'XYKWarehouseLM.AllRewardsDistributed')
        this._chain = ctx._chain
        this.event = event
    }
     ...
     */
    get isV88(): boolean {
        return this._chain.getEventHash('XYKWarehouseLM.AllRewardsDistributed') === '6c81d62dc35d0454853f5260a9937f1dea716b76a958a096c5baa5a1f4a88cce'
    }

    /**
     * Global farm has no more rewards to distribute in the moment.
     */
    get asV88(): {globalFarmId: number} {
        assert(this.isV88)
        return this._chain.decodeEvent(this.event)
    }
}
