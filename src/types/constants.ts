...
export class TransactionPaymentWeightToFeeConstant {
   ...
   *  The polynomial that is applied in order to derive fee from weight.
   */
  get asV72(): v72.WeightToFeeCoefficient[] {
    assert(this.isV72)
